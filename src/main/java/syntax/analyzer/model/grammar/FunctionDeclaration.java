...
public class FunctionDeclaration {
    ...
    public static void callFunctionConsumer(Deque<Token> tokens) throws SyntaxErrorException {
        TerminalsUtil.consumerTokenByType(tokens, TokenType.IDENTIFIER, Terminals.IDENTIFIER);
        TerminalsUtil.consumerTokenByLexame(tokens, OPEN_PARENTHESES);
        try {
            TerminalsUtil.consumerTokenByLexame(tokens, CLOSE_PARENTHESES);
    ...
    public static void argsListConsumer(Deque<Token> tokens) throws SyntaxErrorException {
        argConsumer(tokens);
    ...
    public static void argConsumer(Deque<Token> tokens) throws SyntaxErrorException {
