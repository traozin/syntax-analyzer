...
public class StructDeclaration {
    ...
    public static void structDefConsumer(Deque<Token> tokens) throws SyntaxErrorException {
        Token token = tokens.peek();
    ...
    public static void structUsageConsumer(Deque<Token> tokens) throws SyntaxErrorException{
